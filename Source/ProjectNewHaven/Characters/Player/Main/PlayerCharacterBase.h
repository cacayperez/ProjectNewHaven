...
#include "ProjectNewHaven/Characters/Player/Shared/ControlledCharacterBase.h"
...
UCLASS()
class PROJECTNEWHAVEN_API APlayerCharacterBase : public AControlledCharacterBase, public IICharacter, public IIPlayerCharacter, public IIInteractivity
{
	GENERATED_BODY()
